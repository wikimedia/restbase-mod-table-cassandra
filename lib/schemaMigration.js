...
SecondaryIndexes.prototype.validate = (req, current, proposed) => {
...
SecondaryIndexes.prototype.migrate = () => {
...
RevisionRetentionPolicy.prototype.validate = (req, current, proposed) => confChanged({
